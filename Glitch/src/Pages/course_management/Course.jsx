...
const CourseManagement = () => {
    ...
    const createCourse = async () => {
        ...
        const res = await axios.post('http://localhost:3000/admin/createCourse', { courseData },{withCredentials:true})
        console.log(res)
    }
        ...
        <div className="course-management">
            <div className="sidebar">
                ...
                <ul className="sidebar-menu">
                    ...
                    <li><a onClick={allstudent}>All Student</a></li>
                    <li><a onClick={allfaculty}>All Faculty</a></li>
...
```code example```"
                            ...
                            <div className="form-actions">
                                <button onClick={createCourse} className="btn" disabled={isLoading}>
                                    {isLoading
